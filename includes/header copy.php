        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reserves/idanre.php"><i class="fas fa-leaf me-1"></i>Forest Reserves</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php if (is_logged_in()): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <?php else: ?>
                                    <li><a class="dropdown-item" href="user/index.php"><i class="fas fa-user-circle me-2"></i>User Dashboard</a></li>
                                <?php endif; ?>
                                <li><a class="dropdown-item" href="user/profile.php"><i class="fas fa-user-edit me-2"></i>Profile</a></li>
                                <li><a class="dropdown-item" href="user/transactions.php"><i class="fas fa-receipt me-2"></i>Transactions</a></li>
                                ...
                                <?php foreach ($breadcrumb as $item): ?>
                                    <li class="breadcrumb-item <?php echo $item['active'] ? 'active' : ''; ?>" aria-current="<?php echo $item['active'] ? 'page' : 'false'; ?>">
                                        <?php if ($item['active']): ?>
                                            <?php echo $item['title']; ?>
                                        <?php else: ?>
                                            <a href="<?php echo $item['url']; ?>" style="color: white;"><?php echo $item['title']; ?></a>
                                        <?php endif; ?>
                                    </li>
                                <?php endforeach; ?>
                            <?php else: ?>
