        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="reserves_list.php" class="text-white text-decoration-none">Forest Reserves</a></li>
                    ...
                    <?php if (is_logged_in()): ?>
                        <li class="mb-2"><a href="user/index.php" class="text-white text-decoration-none">User Dashboard</a></li>
                    <?php else: ?>
